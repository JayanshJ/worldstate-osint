...
const TzContext = createContext<TzCtx>({ timezone: DEFAULT_TZ, setTimezone: () => {} })

export function TimezoneProvider({ children }: { children: React.ReactNode }) {
  const [timezone, setTzState] = useState<string>(
    () => localStorage.getItem('user_tz') || DEFAULT_TZ
  )
  ...
  return <TzContext.Provider value={{ timezone, setTimezone }}>{children}</TzContext.Provider>
}
